    ...
    <div className="technical-service">
      ...
      <div className="technical-info-container">
        ...
        <div className="text">
          ...
          the whole shift) will follow. Thanks to our vast know-how from
          successful projects around the world, we are able to give insights and
          best practice cases. In order to be as close to our customers as
          possible, our technical service staff develops a close relationship to
          the key players at the plants and is ready for emergency visits at any
          point of time. We also provide our know-how to the technical marketing
          team during their project management, by undertaking line evaluations
          as well as trials and product testing in our own labs.
        </div>
      </div>
      <div className="technical-info-container">
        <img alt="" className="image" src={Amazon} />
        <div className="text">
          ...
          of information within the communication process. We offer numerous
          solutions so that your package stands out at the point of sale. Our
          solutions include top printing, embossing, debossing. One of the most
          significant insights in marketing is that product customization
          influences consumer behaviour. In recent years, our customers have
          regularly sent us queries on personalized and customized products, and
          we have tried to fulfil them all to the best of our abilities and will
