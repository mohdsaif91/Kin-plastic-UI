...
import { ChevronRight, ChevronLeft, ExitToApp, GroupWork, Home, Inbox } from '@material-ui/icons';
		...
		<div className={classes.root}>
			...
			>
				<div className="drawer-header">
					{open && (
						<Typography className="header-logo-name drawer-header" variant="h6" noWrap>
							Kin Industries
						</Typography>
					)}
				...
				<List className="list-nav">
					<ListItem button className="nav-active" key="Home">
						<ListItemIcon>
